...
from core.model.base import MyModule
from core.model.common import build_activation
from core.model.utils import int2list, adjust_bn_according_to_idx, copy_bn, get_net_device

from .op import *
from core.model.layers import MBInvertedConvLayer, ConvLayer, LinearLayer
...
class DynamicMBConvLayer(MyModule):
    ...
    def __init__(self, in_channel_list, out_channel_list,
        ...
        if max(self.expand_ratio_list) == 1:
            ...
            print(self.expand_ratio_list, "not build inverted_bottleneck")
        else:
    ...
    def get_active_subnet(self, in_channel, preserve_weight=True):
        ...
        sub_layer = MBInvertedConvLayer(
            in_channel, self.active_out_channel, self.active_kernel_size, self.stride, 
